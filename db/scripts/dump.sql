...
INSERT INTO `AuctionDB`.`USERS` (`USERNAME`, `PASSWORD`) VALUES ('Alex', 'Alex');
INSERT INTO `AuctionDB`.`USERS` (`USERNAME`, `PASSWORD`) VALUES ('Dmytro', 'Dmytro');
INSERT INTO `AuctionDB`.`USERS` (`USERNAME`, `PASSWORD`) VALUES ('Ahmed', 'Ahmed');
INSERT INTO `AuctionDB`.`USERS` (`USERNAME`, `PASSWORD`) VALUES ('Adam', 'Adam');
INSERT INTO `AuctionDB`.`USERS` (`USERNAME`, `PASSWORD`) VALUES ('Mateusz', 'Mateusz');
INSERT INTO `AuctionDB`.`USERS` (`USERNAME`, `PASSWORD`) VALUES ('Yaroslav', 'Yaroslav');