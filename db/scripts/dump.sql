...
INSERT INTO `AuctionDB`.`USERS` (`USER_NAME`, `PASSWORD`) VALUES ('Alex', 'Alex');
INSERT INTO `AuctionDB`.`USERS` (`USER_NAME`, `PASSWORD`) VALUES ('Dmytro', 'Dmytro');
INSERT INTO `AuctionDB`.`USERS` (`USER_NAME`, `PASSWORD`) VALUES ('Ahmed', 'Ahmed');
INSERT INTO `AuctionDB`.`USERS` (`USER_NAME`, `PASSWORD`) VALUES ('Adam', 'Adam');
INSERT INTO `AuctionDB`.`USERS` (`USER_NAME`, `PASSWORD`) VALUES ('Mateusz', 'Mateusz');
INSERT INTO `AuctionDB`.`USERS` (`USER_NAME`, `PASSWORD`) VALUES ('Yaroslav', 'Yaroslav');